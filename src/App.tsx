...
import heroProfileImage from './assets/hero-profile-image.jpg';
      ...
      <div className="relative z-10 px-6 max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-16 md:gap-12 w-full">
        ...
        >
          ...
          >
            ...
            >
              <img src={heroProfileImage} alt="Background 2" className="w-full h-full object-cover opacity-40 group-hover:opacity-80 transition-opacity duration-700" />
            ...
            >
              <img src={heroProfileImage} alt="Background 1" className="w-full h-full object-cover opacity-60 group-hover:opacity-90 transition-opacity duration-700" />
